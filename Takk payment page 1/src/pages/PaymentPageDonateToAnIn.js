import styles from "./PaymentPageDonateToAnIn.module.css";
const PaymentPageDonateToAnIn = () => {
  return (
    <div className={styles.paymentPageDonateToAnIn}>
      ...
      <div className={styles.image62Parent}>
        ...
        <img className={styles.image51Icon} alt="" src="/image-511@2x.png" />
        ...
        <div className={styles.image9Parent}>
          ...
          <div className={styles.youDonated343}>You donated £343</div>
          <img className={styles.image127Icon} alt="" src="/image-127@2x.png" />
          <img className={styles.image128Icon} alt="" src="/image-128@2x.png" />
          <img className={styles.image129Icon} alt="" src="/image-129@2x.png" />
        </div>
        <div className={styles.frameChild1} />
        <div
          className={styles.descriptionAboutCommunity}
        >{`Description about community Lorem ipsum dolor sit, amet consectetur adipisicing elit. Cumque similique eaque delectus unde commodi assumenda, rerum, et doloribus nobis qui eius voluptatum vitae suscipit quos quod? Description about community post Lorem ipsum dolor sit, amet consectetur adipisicing elit. `}</div>
        <div className={styles.rectangleGroup}>
          <div className={styles.groupInner} />
          <b className={styles.createPost}>
            <p className={styles.blankLine}>Create Post</p>
          </b>
        </div>
        <b className={styles.initiativePosts}>Initiative Posts</b>
        <img className={styles.image102Icon} alt="" src="/image-102@2x.png" />
        <div className={styles.descriptionAboutCommunity1}>
          Description about community post Lorem ipsum dolor sit, amet
          ...
          suscipit quos quod? Description about community Lorem ipsum dolor sit,
          amet consectetur adipisicing elit. Cumque similique eaque delectus
          unde commodi assumenda, rerum, et doloribus nobis qui eius voluptatum
          vitae suscipit quos quod?
        </div>
        ...
        <img className={styles.image51Icon1} alt="" src="/image-512@2x.png" />
        ...
        <img className={styles.image113Icon} alt="" src="/image-512@2x.png" />
        ...
        <img className={styles.frameChild6} alt="" src="/line-50.svg" />
        <img className={styles.image114Icon} alt="" src="/image-104@2x.png" />
        <img className={styles.image116Icon} alt="" src="/image-106@2x.png" />
        <div className={styles.comments1}>20 Comments</div>
        ...
        <div className={styles.view55More}>view 55 more comments</div>
        ...
        <div className={styles.tagsParent}>
          ...
          <div className={styles.seeAllTags}>See all tags....</div>
          ...
          <div className={styles.rectangleParent1}>
            ...
            <div className={styles.sports}>
              <p className={styles.blankLine}>Sports</p>
            </div>
          </div>
        ...
        <div className={styles.titleOfTheInitiativeWrapper}>
          <div className={styles.titleOfThe}>Title of the Initiative</div>
        </div>
        <div className={styles.helloDescriptionAbout}>
          Hello, Description about
        </div>
        <div
          className={styles.descriptionAboutCommunity4}
        >{`Description about community post Lorem ipsum Descriptio asflgkjsdflkmvldkcmv al fsa fg sdfgsdølfkgøsd fg sd fg sødflkvpsdokfg sdf . `}</div>
        ...
        <div className={styles.image51Parent}>
          <img className={styles.image51Icon2} alt="" src="/image-511@2x.png" />
          <img className={styles.image61Icon} alt="" src="/image-611@2x.png" />
          <div className={styles.frameDiv} />
          <div className={styles.frameChild8} />
        </div>
        <img className={styles.image95Icon} alt="" src="/image-95@2x.png" />
        <div className={styles.initiativeOwner}>Initiative owner</div>
      </div>
      ...
      <div className={styles.editcreateCommunityPage}>
        <div className={styles.takkLogoYellow2Group}>
          <img
            className={styles.takkLogoYellow21}
            alt=""
          ...
          <div className={styles.nameOfUser1}>Name of User</div>
          <img className={styles.frameItem} alt="" src="/ellipse-41@2x.png" />
        ...
        <div className={styles.frameParent}>
          <div className={styles.aboutYourCommunityParent}>
            ...
            <div className={styles.someWords}>
              <p className={styles.blankLine}>Some words</p>
            </div>
          ...
          <img className={styles.frameChild13} alt="" src="/line-32.svg" />
          <img className={styles.frameChild14} alt="" src="/line-33.svg" />
        ...
        <div className={styles.summaryOfServiceParent}>
          <div className={styles.summaryOfServiceContainer}>
            <p className={styles.blankLine}>Summary of Service</p>
            <p className={styles.blankLine}>&nbsp;</p>
          </div>
          <b className={styles.titleOfThe1}>Title of the Community</b>
          ...
          <img className={styles.image51Icon3} alt="" src="/image-511@2x.png" />
          <img className={styles.image62Icon1} alt="" src="/image-62@2x.png" />
          <img className={styles.image63Icon1} alt="" src="/image-63@2x.png" />
          <img className={styles.frameChild19} alt="" src="/line-17.svg" />
          <b className={styles.descriptionOfTheContainer}>
            <p className={styles.blankLine}>Description of the Community</p>
          </b>
      ...
      <div className={styles.communitiesParent}>
        ...
        <div className={styles.image7Group}>
          ...
          <div className={styles.overviewOfTheInitiativeForGroup}>
            ...
            <div className={styles.findOutMore1}>Find out more</div>
            <b className={styles.titleOfThe3}>Title of the Community</b>
          </div>
        </div>
      </div>
      <div className={styles.paymentPageDonateToAnInChild} />
      ...
      <div className={styles.frameParent1}>
        ...
        <div className={styles.frameParent2}>
          ...
          <div
            className={styles.weDontCharge}
          >{`We don't charge a platform fee, but there are still costs involved in processing donations. By adding a small contribution on top of your donation, you'll cover these costs, making sure the initiative continues to get 100% of your donation. `}</div>
        </div>
        <div className={styles.continue}>Continue</div>
        <div
          className={styles.itsTimeTo}
        >{`It’s time to decide on how much you want to donate, and whether you want to donate on a monthly recurring basis or only one time. Please choose from the `}</div>
      </div>
      <div className={styles.rectangleParent6}>
        <button className={styles.rectangleButton} />
        <div className={styles.continue1}>Continue</div>
        <button className={styles.cancel1}>Cancel</button>
      </div>
    </div>
  );
};

export default PaymentPageDonateToAnIn;
