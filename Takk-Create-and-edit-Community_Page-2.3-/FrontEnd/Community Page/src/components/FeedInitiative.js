...
const FeedInitiative = ({ communities }) => {
  ...
  return (
    <div className={styles.image62Parent}>
      ...
      <img className={styles.image96Icon} alt="" src={communities.imagesAndVideo} />;
            <div
        className={styles.descriptionAboutCommunity}
      >{communities.descriptionOfInitiative || ''}</div>
      ...
      <div className={styles.titleOfThe}>{communities.nameofInitiative || ''}</div>
      </div>
