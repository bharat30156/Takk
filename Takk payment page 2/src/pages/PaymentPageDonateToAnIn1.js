import styles from "./PaymentPageDonateToAnIn1.module.css";
const PaymentPageDonateToAnIn1 = () => {
  return (
    <div className={styles.paymentPageDonateToAnIn}>
      ...
      <div className={styles.frameParent1}>
        ...
        <div
          className={styles.pleaseSelectA}
        >{`Please select a payment method from the list. After the final confirmation of your donation, you will be taken to the payment provider to complete the transaction. `}</div>
      ...
      <div className={styles.rectangleParent7}>
        <button className={styles.groupChild11} />
...
export default PaymentPageDonateToAnIn1;
