import JoinAndShare from "./JoinAndShare";
import ImageSection from "./ImageSection";
import Tags from "./Tags";
import AssociatedInitiative from "./AssociatedInitiative";
...
const FeedInitiative = ({ initiative }) => {
  console.log('Initiative Prop:', initiative);
  ...
  return (
    <div className={styles.image62Parent}>
      ...
      <Link to="/InitiativeCreateEdit" state={{originalformData: initiative}}>
        <button className={styles.image129} />
      </Link>

      <img className={styles.frameChild} alt="" src="../rectangle-2.svg" />
      <div className={styles.joinCommunity}>Donate Now</div>
    </div>


      <div className={styles.frameItem} />
      
      <img className={styles.image96Icon} alt="" src={initiative.imagesAndVideo} />;
            <div
        className={styles.descriptionAboutCommunity}
      >{initiative.descriptionOfInitiative || ''}</div>
      ...
      <div className={styles.titleOfThe}>{initiative.nameofInitiative || ''}</div>
      </div>
