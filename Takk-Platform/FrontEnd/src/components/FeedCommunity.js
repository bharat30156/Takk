...
const FeedCommunity = ({ communities }) => {
  ...
  console.log(55,communities.images)

  return (
    <div className={styles.image62Parent}>

<Link to ="/CommunityCreateEdit" state={{originalformData: communities}}>Edit community</Link>
      ...
      <img className={styles.image96Icon} alt="" src={communities.images}/>;
