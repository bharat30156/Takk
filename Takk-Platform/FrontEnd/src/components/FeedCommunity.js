...
const FeedCommunity = ({ community }) => {
  console.log('FeedCommunities communities:', community);
  //console.log(communities.images, "community images")
  ...
  return (
    <div className={styles.image62Parent}>
      ...
      <ImageSlider imageDataList={community.images}/>
      
      
      <div className={styles.titleOfTheCommunityWrapper}>      
        <div className={styles.titleOfThe}>{community.nameOfCommunity || ''}</div>
      </div>

     
    
      <JoinAndShare community={community}/>
      <div className={styles.frameItem} />


      <div className={styles.descriptionAboutCommunity}>{community.descriptionOfCommunity || ''}</div>
      ...
      <AssociatedInitiative initiatives={community.initiatives}/>
