...
const InitiativeViewPage = (props) => {
  ...
  console.log(22,originalformData.nameofInitiative)
...
<div className={styles.image62Parent}>
     ...
     {/* <div className={styles.frameChild} /> */}
      ...
      <Link to="/InitiativeCreateEdit" state={{originalformData: originalformData}}>
      ...
      <img className={styles.image96Icon} alt="" src={originalformData.imagesAndVideo} />;
            <div
        className={styles.descriptionAboutCommunity}
      >{originalformData.descriptionOfInitiative || ''}</div>
      ...
      <div className={styles.titleOfThe}>{originalformData.nameofInitiative || ''}</div>
      </div>
