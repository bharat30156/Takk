...
const PersonalDashBoard = () => {
  return (
    <div className={styles.personalDashboard}>
      ...
      <b className={styles.johnSmith}>{localStorage.getItem(USER_NAME)}</b>
        ...
        <div className={styles.frameGroup}>
          ...
          <div className={styles.image7Container}>
            ...
            <div className={styles.overviewOfTheInitiativeForParent}>
              ...
              <div className={styles.findOutMore2}>Find out more</div>
              <b className={styles.titleOfThe2}>Title of the Initiative</b>
            </div>
          </div>
          <div className={styles.frameDiv}>
            ...
            <div className={styles.overviewOfTheInitiativeForParent}>
              ...
              <button className={styles.findOutMore}>Find out more</button>
              <b className={styles.titleOfThe3}>Title of the Initiative</b>
            </div>
          </div>
          <div className={styles.image7Parent1}>
            ...
            <div className={styles.overviewOfTheInitiativeForParent}>
              ...
              <button className={styles.findOutMore}>Find out more</button>
              <b className={styles.titleOfThe4}>Title of the Initiative</b>
            </div>
          </div>
          ...
          <div className={styles.image7Parent3}>
            ...
            <div className={styles.overviewOfTheInitiativeForGroup}>
              ...
              <button className={styles.findOutMore}>Find out more</button>
              <b className={styles.titleOfThe6}>Title of the Initiative</b>
            </div>
          </div>
          ...
          <div className={styles.image7Parent5}>
            ...
            <div className={styles.overviewOfTheInitiativeForGroup}>
              ...
              <button className={styles.findOutMore}>Find out more</button>
              <b className={styles.titleOfThe8}>Title of the Initiative</b>
            </div>
          </div>
        </div>
