...
function App() {
  ...
  return (
    ...
    <DataProvider>
      ...
      {previousLocation && (
        <Routes>
          <Route path="/PaymentPageDonate1/:id" element={<PaymentPageDonate1 />} />
          <Route path="/PaymentPageDonate2/:id" element={<PaymentPageDonate2 />} />
          <Route path="/PaymentPageDonate3/:id" element={<PaymentPageDonate3 />} />
        </Routes>
      )}
