...
const MacBookPro161 = () => {
  return (
    <div className={styles.macbookPro161}>
      <div className={styles.theNameOfYourInitiativeParent}>
        <b className={styles.theNameOf}>The name of your initiative*:</b>
        <input className={styles.frameChild} type="text" />
        <b className={styles.aDescriptionOf}>
          A description of your initiative*:
        </b>
        ...
        <div className={styles.addAProductservice}>
      ...
      <div className={styles.takkLogoYellow2Parent}>
        ...
        <img className={styles.frameChild34} alt="" src="/ellipse-4@2x.png" />
        <div className={styles.ellipseParent}>
          <img className={styles.groupChild1} alt="" src="/ellipse-51.svg" />
